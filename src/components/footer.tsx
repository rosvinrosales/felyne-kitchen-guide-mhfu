  ...
  return (
    <CardFooter>
      <div className="text-xs">
        ...
        <p>
          Frugality = Stops Breakable items, such as Pickaxes and Bugnets from
          breaking as often
        </p>
        ...
        <p>Charisma = Gives you longer conversations with the Vege Elder.</p>
        <p>Ballooner = 100% chance of Balloon appearing on a daytime Quest.</p>
        <p>Blunt Force = Increases attack power of Bow Gun's melee attack.</p>
        <p>Temper = Power of Bowguns increase, range decreases.</p>
        <p>Gathering = Rarer items from gathering are proccured.</p>
        <p>Escape = When sprinting from a Monster, you lose less Stamina.</p>
        ...
        <p>Defense = Chance of decreased damage when a Monster hits you.</p>
        ...
        <p>
          Strongcat = When carrying an Egg, small attacks such as insects can't
          interrupt you.
        </p>
        ...
        <p>
          Resilience = When knocked down you become invincible while you get up.
        </p>
